...
| Setting               | SDR Mode | HDR Mode                                                                                                                                                                     |
|-----------------------|----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| HDR Content Brightness | Not Applicable | For accurate measurement, adjust according to the brightness slider values: <br>- **Surface Laptop Studio 2**: Set "Brightness Slider" to **46** and "HDR Content Brightness Slider" to **1**.<br> - **Surface Laptop 7th Edition, Qualcomm processor  & Surface Pro (11th Edition)**: Set "Brightness Slider" to **47** and "HDR Content Brightness Slider" to **6**.   |
