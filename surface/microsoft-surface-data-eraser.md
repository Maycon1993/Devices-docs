...
This version of Surface Data Eraser is not compatible with the latest Surface devices including Surface Pro 10, Surface Pro (11th Edition), Surface Laptop 6 and Surface Laptop 7th Edition, Qualcomm processor . For these and all subsequent devices, see [Surface Data Eraser (IT Toolkit)](surface-it-toolkit-data-eraser.md).
...
8. Select **X** to close Surface Data Eraser.
