...
> [!NOTE]
> Surface Pro 11th Edition with Intel processor, Surface Pro 10 5G, and Surface Laptop 7th Edition with Intel processor now support deployment with Windows 11, version 23H2. Factory images for Windows 11 23H2 are not available. Organizations must download and install the OS themselves and integrate the MSI driver and firmware package into their imaging solution. While Windows 11 23H2 expands deployment flexibility, some features supported in Windows 11 24H2 are not available in 23H2.
