...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------- | -------------------------------------------      | -------------- |--------------
| Surface Hub 3          | Surface Hub 3 devices shipped from the factory, with a 14 digit alphanumeric serial number                            | - Partner-driven on behalf of customer (recommended)<br><br>- Submit request to [Microsoft support](/surface/surface-autopilot-registration-support) <br><br>**NOTE:** Both of these enrollment methods can take advantage of [Device Firmware Configuration Interface (DFCI)](/surface/surface-manage-dfci-guide), now supported on Surface Hub 3.| [Enroll in Autopilot](#enroll-a-new-surface-hub-3)   |  [Reseller, distributor, or partner registration](/autopilot/partner-registration) <br> <br> [Surface partners enabled for Autopilot](/surface/windows-autopilot-and-surface-devices#surface-partners-enabled-for-windows-autopilot)          |
| Surface Hub 3          | Surface Hub 3 devices shipped from the factory, with a 12 digit numeric serial number           | - Customer-driven directly in Intune     | [Manually register devices & enroll](#manually-register--enroll-surface-hub-2s-devices-upgraded-with-a-surface-hub-3-compute-cartridge) | [Manually register devices with Windows Autopilot](/autopilot/add-devices)           |
