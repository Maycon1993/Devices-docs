...
Surface Hub running Teams Rooms on Windows is compatible with all [Teams certified audio and video accessories](/microsoftteams/rooms/certified-hardware?tabs=Devices#tabpanel_1_Devices). This includes Surface Hub 3, Surface Hub 2S devices [migrated](surface-hub-2s-migrate-to-mtr-w.md) to run Teams Rooms on Windows and Surface Hub 2S devices [upgraded](install-manage-surface-hub-3-compute-cartridge.md) with the Surface Hub 3 Compute Cartridge (formerly Surface Hub 3 Pack).
