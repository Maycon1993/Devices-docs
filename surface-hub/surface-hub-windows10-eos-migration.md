...
- The Microsoft Teams app (that preceded Microsoft Teams Rooms on Windows) is deprecated. To learn more, see [Microsoft Teams App End of Availability on Surface Hub v1 and 2S Running Windows 10 Team Edition](/microsoftteams/rooms/rooms-lifecycle-support#microsoft-teams-app-end-of-availability-on-surface-hub-v1-and-2s-running-windows-10-team-edition).
