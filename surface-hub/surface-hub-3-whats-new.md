...
| **Microsoft Store, Edge browser & native apps** | Supports a range of applications outside of Teams, including Microsoft Office applications, Microsoft Edge, and third-party apps from the Microsoft Store. | Support for **Microsoft Edge on Teams Rooms for Windows** touch boards is coming in 2025 – including Surface Hub. This will provide access to the Microsoft, third party, and internal line-of-business web-based apps and tools you and your teams use to collaborate.*  Targeted for public preview in Q2 of this calendar year (2025), and general availability in Q3. [Learn more here](https://techcommunity.microsoft.com/blog/surfaceitpro/introducing-edge-and-miracast-on-surface-hub-3/4365746).
 
In the meantime, users can easily share content from any apps running on their personal devices using [Teams Cast](https://support.microsoft.com/office/cast-content-from-your-desktop-to-a-microsoft-teams-room-6d62cdbb-3da2-4bb9-80bd-9cf1098beb3d) or Desktop Sharing during meetings.
 
For more app experiences, migrating to [Windows 11 Pro or Enterprise](surface-hub-3-migrate-os.md) enables full access to apps.
 |
| **Access to personal files & login**         | Users can log in to the Windows OS itself to access their personal meetings and files and create a personalized experience. | Support for **Microsoft Edge on Teams Rooms for Windows** touch boards is coming in 2025 – including Surface Hub. When you use Edge to log into web-based apps and tools,* your personalized experience and files will be at your fingertips for brainstorming, collaborative editing, or presenting. Targeted for public preview in Q2 of this calendar year (2025), and general availability in Q3. [Learn more here](https://techcommunity.microsoft.com/blog/surfaceitpro/introducing-edge-and-miracast-on-surface-hub-3/4365746).

In the meantime, users can easily share content from these apps running on their personal devices using [Teams Cast](https://support.microsoft.com/office/cast-content-from-your-desktop-to-a-microsoft-teams-room-6d62cdbb-3da2-4bb9-80bd-9cf1098beb3d) or Desktop Sharing during meetings.

For users needing constant access to personal content on Surface Hubs, migrating to [Windows 11 Pro or Enterprise](https://learn.microsoft.com/en-us/surface-hub/surface-hub-3-migrate-os) enables full access to personal content within perpetually signed-in app experiences. |
